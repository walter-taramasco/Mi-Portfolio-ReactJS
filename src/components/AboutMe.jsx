  ...
  return (
    <>
      <div className="sobremi__div">
        ...
        <p className="sobremi__p">
          Cada proyecto para mí fue muy significante, ya sea porque aportó tanto
          en mi experiencia como en mi aprendizaje. Pero un proyecto que realizó
          un punto de inflexión para mí fue el de la página web Cabaña La
          Pitufina, este además de ser mi primer proyecto fue el que realmente
          me hizo saber que esto era lo mío.
        </p>
